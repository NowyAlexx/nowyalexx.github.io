...
function createModCard(settings) {
    ...
    modCard.className = 'mod-link'; // Make the entire card a link
    modCard.href = `/c/mod-details.html?id=${settings.id}`; // Redirect to mod details with ID in URL

    const cardContent = document.createElement('div');
    cardContent.className = 'mod-card';
    ...
    cardContent.appendChild(iconsContainer); // Add the icons container to the mod card
    ...
    cardContent.appendChild(listDesc);
    ...
    cardContent.appendChild(infoContainer); // Add info container to mod card
    modCard.appendChild(cardContent); // Append content to the anchor link
